...
Alternatively, if a [`CharTokeniser`](MagicText/src/CharTokeniser.cs) is used instead of the [`RegexSplitTokeniser`](MagicText/src/RegexSplitTokeniser.cs), the code outputs:
