...
namespace MagicText
{
    /// <summary>Implements a <see cref="RegexTokeniser" /> which shatters lines of text by capturing and extracting specific regular expression pattern matches.</summary>
    /// <remarks>
    ///     <para>This <see cref="RegexTokeniser" /> extension class simulates the <see cref="System.Text.RegularExpressions.Regex.Matches(String)" /> method, unlike the <see cref="RegexSplitTokeniser" />, which simulates the <see cref="System.Text.RegularExpressions.Regex.Split(String)" /> method, on each line of text.</para>
    ...
    {
        private const string MatchingNotSupportedErrorMessage = "The default matching passed in is currently not supported.";
        ...
        /// </remarks>
        private static System.Text.RegularExpressions.Regex DefaultWordsOrNonWordsRegex => _defaultWordsOrNonWordsRegex;
        ...
        /// </remarks>
        private static System.Text.RegularExpressions.Regex DefaultWordsOrPunctuationOrWhiteSpaceRegex => _defaultWordsOrPunctuationOrWhiteSpaceRegex;
        ...
        /// </remarks>
        private static System.Text.RegularExpressions.Regex DefaultWordsOrPunctuationRegex => _defaultWordsOrPunctuationRegex;
        ...
        /// </remarks>
        private static System.Text.RegularExpressions.Regex DefaultWordsRegex => _defaultWordsRegex;
