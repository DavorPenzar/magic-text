...
namespace MagicText
{
    ...
    public class RegexSplitTokeniser : RegexTokeniser
    {
        ...
        protected Func<String, String?>? TransformToken => _transformToken;
        ...
        public RegexSplitTokeniser([RegexPattern] String pattern, Boolean escape = false, RegexOptions options = RegexOptions.None, Func<String, String?>? transformToken = null) : base(pattern, escape, options)
        {
            _transformToken = transformToken;
        }
