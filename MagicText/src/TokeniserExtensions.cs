...
namespace MagicText
{
    ...
    public static class TokeniserExtensions
    {
        ...
        ///     <para>This extension method is essentially the same as chaining the <see cref="ITokeniser.Shatter(TextReader, ShatteringOptions)" /> method and the <see cref="Enumerable.ToArray{TSource}(IEnumerable{TSource})" /> extension method. However, it is still provided as a convenient single-call self-explanatory method.</para>
        /// </remarks>
        ...
        ///
        ///     <h3><a href="http://docs.microsoft.com/en-gb/dotnet/csharp/programming-guide/concepts/linq/"><em>LINQ</em></a> Alternatives</h3>
        ///     <para>This extension method is similar to chaining the <see cref="ITokeniser.ShatterAsync(TextReader, ShatteringOptions, Boolean, CancellationToken)" /> method and the <see cref="M:System.Linq.AsyncEnumerable.ToArrayAsync``1(System.Collections.Generic.IAsyncEnumerable{``0},System.Threading.CancellationToken)" /> extension method. However, other than being a convenient single-call self-explanatory method, this method provides additional possibilities, such as intercepting the <see cref="OperationCanceledException" /> via the <c><paramref name="throwExceptionOnCancellation" /></c> and <c><paramref name="interceptCancellationCallback" /></c> parameters.</para>
        /// </remarks>
        public static async Task<String?[]> ShatterToArrayAsync(this ITokeniser tokeniser, TextReader inputReader, ShatteringOptions? options = null, Boolean continueTasksOnCapturedContext = false, Boolean throwExceptionOnCancellation = true, Action<OperationCanceledException>? interceptCancellationCallback = null, CancellationToken cancellationToken = default)
        {
            if (tokeniser is null)
            {
                throw new ArgumentNullException(nameof(tokeniser), TokeniserNullErrorMessage);
        ...
        ///
        ///     <h3><a href="http://docs.microsoft.com/en-gb/dotnet/csharp/programming-guide/concepts/linq/"><em>LINQ</em></a> Alternatives</h3>
        ///     <para>This extension method is similar to chaining the <see cref="ShatterAsync(ITokeniser, String, ShatteringOptions, Boolean, CancellationToken)" /> extension method and the <see cref="M:System.Linq.AsyncEnumerable.ToArrayAsync``1(System.Collections.Generic.IAsyncEnumerable{``0},System.Threading.CancellationToken)" /> extension method. However, other than being a convenient single-call self-explanatory method, this method provides additional possibilities, such as intercepting the <see cref="OperationCanceledException" /> via the <c><paramref name="throwExceptionOnCancellation" /></c> and <c><paramref name="interceptCancellationCallback" /></c> parameters.</para>
        /// </remarks>
        ...
        ///
        ///     <h3><a href="http://docs.microsoft.com/en-gb/dotnet/csharp/programming-guide/concepts/linq/"><em>LINQ</em></a> Alternatives</h3>
        ///     <para>This extension method is similar to chaining the <see cref="ShatterAsync(ITokeniser, Stream, Encoding, ShatteringOptions, Boolean, CancellationToken)" /> extension method and the <see cref="M:System.Linq.AsyncEnumerable.ToArrayAsync``1(System.Collections.Generic.IAsyncEnumerable{``0},System.Threading.CancellationToken)" /> extension method. However, other than being a convenient single-call self-explanatory method, this method provides additional possibilities, such as intercepting the <see cref="OperationCanceledException" /> via the <c><paramref name="throwExceptionOnCancellation" /></c> and <c><paramref name="interceptCancellationCallback" /></c> parameters.</para>
        /// </remarks>
        ...
        ///     <para>This extension method is similar to chaining the <see cref="ShatterAsync(ITokeniser, Stream, ShatteringOptions, Boolean, CancellationToken)" /> extension method and the <see cref="M:System.Linq.AsyncEnumerable.ToArrayAsync``1(System.Collections.Generic.IAsyncEnumerable{``0},System.Threading.CancellationToken)" /> extension method. However, other than being a convenient single-call self-explanatory method, this method provides additional possibilities, such as intercepting the <see cref="OperationCanceledException" /> via the <c><paramref name="throwExceptionOnCancellation" /></c> and <c><paramref name="interceptCancellationCallback" /></c> parameters.</para>
        /// </remarks>
        public static async Task<String?[]> ShatterToArrayAsync(this ITokeniser tokeniser, Stream input, ShatteringOptions? options = null, Boolean continueTasksOnCapturedContext = false, Boolean throwExceptionOnCancellation = true, Action<OperationCanceledException>? interceptCancellationCallback = null, CancellationToken cancellationToken = default) =>
            await ShatterToArrayAsync(tokeniser, input, DefaultEncoding, options, continueTasksOnCapturedContext, throwExceptionOnCancellation, interceptCancellationCallback, cancellationToken).ConfigureAwait(continueTasksOnCapturedContext);
    }
}
