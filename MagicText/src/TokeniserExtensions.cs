...
namespace MagicText
{
    ...
    public static class TokeniserExtensions
    {
        ...
        ///
        ///     <h3><a href="http://docs.microsoft.com/en-gb/dotnet/csharp/programming-guide/concepts/linq/"><em>LINQ</em></a> Alternatives</h3>
        ///     <para>This extension method is similar to chaining the <see cref="ITokeniser.ShatterAsync(TextReader, ShatteringOptions, Boolean, CancellationToken)" /> method and the <see cref="M:System.Linq.AsyncEnumerable.ToArrayAsync``1(System.Collections.Generic.IAsyncEnumerable{``0},System.Threading.CancellationToken)" /> extension method. However, other than being a convenience single-call self-explanatory method, this method provides additional possibilities, such as intercepting the <see cref="OperationCanceledException" /> via the <c><paramref name="throwExceptionOnCancellation" /></c> and <c><paramref name="interceptCancellationCallback" /></c> parameters.</para>
        /// </remarks>
        ...
        ///
        ///     <h3><a href="http://docs.microsoft.com/en-gb/dotnet/csharp/programming-guide/concepts/linq/"><em>LINQ</em></a> Alternatives</h3>
        ///     <para>This extension method is similar to chaining the <see cref="ShatterAsync(ITokeniser, String, ShatteringOptions, Boolean, CancellationToken)" /> extension method and the <see cref="M:System.Linq.AsyncEnumerable.ToArrayAsync``1(System.Collections.Generic.IAsyncEnumerable{``0},System.Threading.CancellationToken)" /> extension method. However, other than being a convenience single-call self-explanatory method, this method provides additional possibilities, such as intercepting the <see cref="OperationCanceledException" /> via the <c><paramref name="throwExceptionOnCancellation" /></c> and <c><paramref name="interceptCancellationCallback" /></c> parameters.</para>
        /// </remarks>
        ...
        ///
        ///     <h3><a href="http://docs.microsoft.com/en-gb/dotnet/csharp/programming-guide/concepts/linq/"><em>LINQ</em></a> Alternatives</h3>
        ///     <para>This extension method is similar to chaining the <see cref="ShatterAsync(ITokeniser, Stream, Encoding, ShatteringOptions, Boolean, CancellationToken)" /> extension method and the <see cref="M:System.Linq.AsyncEnumerable.ToArrayAsync``1(System.Collections.Generic.IAsyncEnumerable{``0},System.Threading.CancellationToken)" /> extension method. However, other than being a convenience single-call self-explanatory method, this method provides additional possibilities, such as intercepting the <see cref="OperationCanceledException" /> via the <c><paramref name="throwExceptionOnCancellation" /></c> and <c><paramref name="interceptCancellationCallback" /></c> parameters.</para>
        /// </remarks>
