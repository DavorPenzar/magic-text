...
namespace MagicText
{
    ...
    public class RegexBreakTokeniser : LineByLineTokeniser
    {
        ...
        /// <remarks>
        ///     <para>Shattering a line of text <c>line</c> (not ending in a line end (CR, LF or CRLF)) by the tokeniser, without transformation, filtering and replacement of empty lines, is done by calling <see cref="Breaker" />'s <see cref="Regex.Split(String)" /> method with <c>line</c> as the argument.</para>
        /// </remarks>
