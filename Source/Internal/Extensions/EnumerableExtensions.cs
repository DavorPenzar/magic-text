...
namespace MagicText.Internal.Extensions
{
    ...
    internal static class EnumerableExtensions
    {
        ...
        /// <param name="firstMatch">If an item of type <c><typeparamref name="TMatch" /></c> is found in the <c><paramref name="source" /></c>, <c><paramref name="firstMatch" /></c> is set to the first such occurance.</param>
        ...
        /// <exception cref="ArgumentNullException">The <c><paramref name="source" /></c> parameter is <c>null</c>.</exception>
        /// <remarks>
        ///     <para>In order to (try to) find an item of type <c><typeparamref name="TMatch" /></c> in the <c><paramref name="source" /></c>, the <c><paramref name="source" /></c> must be enumerated. If a match is found (<c><paramref name="firstMatch" /></c>), the enumeration stops immediately.</para>
        /// </remarks>
