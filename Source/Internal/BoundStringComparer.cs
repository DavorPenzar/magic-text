...
namespace MagicText.Internal
{
    ...
    internal sealed class BoundStringComparer : Object, IComparable<String>, IEquatable<String>, IComparable
    {
        ...
        /// <summary>Compares the <see cref="String" /> to the <c><paramref name="obj" /></c> and returns a value indicating whether one is less than, equal to or greater than the other.</summary>
        /// <param name="obj">The <see cref="System.String" /> to compare.</param>
        /// <returns>If the <see cref="String" /> is less than the <c><paramref name="obj" /></c>, a value less than 0; if the <see cref="String" /> is greater than the <c><paramref name="obj" /></c>, a value greater than 0; if the <see cref="String" /> is equal to the <c><paramref name="obj" /></c>, 0.</returns>
        /// <remarks>
