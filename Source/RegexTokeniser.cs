...
namespace MagicText
{
    ...
    ///     <para>If a default regular expression break pattern <see cref="DefaultInclusiveBreakPattern" /> or <see cref="DefaultExclusiveBreaker" /> should be used without special <see cref="RegexOptions" />, a better performance is achieved when using the default <see cref="RegexTokeniser()" /> constructor or the <see cref="RegexTokeniser(Boolean, Func{String?, String?}?)" /> constructor, in which case a pre-built <see cref="Regex" /> object is used constructed with <see cref="Regex.Options" /> set to the <see cref="DefaultBreakOptions" /> (which includes <see cref="RegexOptions.Compiled" />), instead of the <see cref="RegexTokeniser(String, Boolean, RegexOptions, Func{String?, String?}?)" /> constructor.</para>
    ...
    public class RegexTokeniser : LineByLineTokeniser
    {
        ...
        ///         </listheader>
        ///         <item>
        ///             <term><see cref="RegexOptions.Singleline" /></term>
        ///             <description>Specifies single-line mode.</description>
        ///         </item>
        ///         <item>
        ///             <term><see cref="RegexOptions.CultureInvariant" /></term>
        ///             <description>Specifies that cultural differences in language is ignored.</description>
        ///         </item>
        ///         <item>
        ///             <term><see cref="RegexOptions.Compiled" /></term>
        ///             <description>Specifies that the regular expression is compiled to an assembly.</description>
        ///         </item>
        ///     </list>
        ///     <para>See <see cref="RegexOptions" /> for more information.</para>
        /// </remarks>
        ...
        /// <remarks>
        ///     <para>The regular expression breaker is constructed using the <see cref="DefaultInclusiveBreakPattern" /> with the <see cref="Regex.Options" /> set to the <see cref="DefaultBreakOptions" />.</para>
        ...
        /// <remarks>
        ///     <para>The regular expression breaker is constructed using the <see cref="DefaultExclusiveBreakPattern" /> with the <see cref="Regex.Options" /> set to the <see cref="DefaultBreakOptions" />.</para>
        ...
        /// <param name="transform">The optional token transformation function. If <c>null</c>, no transformation function is used.</param>
        /// <remarks>
        ///     <para>Actually, a pre-built <see cref="Regex" /> object (<see cref="DefaultInclusiveBreaker" /> or <see cref="DefaultExclusiveBreaker" />) with <see cref="Regex.Options" /> set to the <see cref="DefaultBreakOptions" /> is used. Consider using this constructor or the default <see cref="RegexTokeniser()" /> constructor if a default tokeniser should be used to improve performance.</para>
        /// </remarks>
        ...
        ///     <para>Actually, a pre-built <see cref="Regex" /> object (<see cref="DefaultInclusiveBreaker" />) with <see cref="Regex.Options" /> set to the <see cref="DefaultBreakOptions" /> is used. Consider using this constructor or the <see cref="RegexTokeniser(Boolean, Func{String?, String?}?)" /> constructor if a default tokeniser should be used to improve performance.</para>
        /// </remarks>
