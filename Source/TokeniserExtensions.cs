...
namespace MagicText
{
    ...
    public static class TokeniserExtensions
    {
        ...
        /// </exception>
        /// <remarks>
        ///     <para>The returned <see cref="Array" /> is a fully-built container and is therefore safe to enumerate even after disposing the <c><paramref name="input" /></c>. However, as such it is impossible to enumerate it before the complete reading and shattering operation is finished.</para>
        ///     <para>The exceptions thrown by the <see cref="ITokeniser.Shatter(TextReader, ShatteringOptions)" /> method call are not caught.</para>
        ///
        ///     <h3><a href="http://docs.microsoft.com/en-gb/dotnet/csharp/programming-guide/concepts/linq/"><em>LINQ</em></a> Alternatives</h3>
        ///     <para>This extension method is essentially the same as chaining the <see cref="ITokeniser.Shatter(TextReader, ShatteringOptions)" /> method and the <see cref="Enumerable.ToArray{TSource}(IEnumerable{TSource})" /> extension method. In fact, benchmark testing showed minimal overhead memory but no significant time consumption difference in respect of the <a href="http://docs.microsoft.com/en-gb/dotnet/csharp/programming-guide/concepts/linq/"><em>LINQ</em></a> solution. However, it is still provided as a convenience single-call self-explanatory method.</para>
        /// </remarks>
        public static String?[] ShatterToArray(this ITokeniser tokeniser, TextReader input, ShatteringOptions? options = null)
        {
            if (tokeniser is null)
            {
                throw new ArgumentNullException(nameof(tokeniser), TokeniserNullErrorMessage);
            ...
            return tokeniser.Shatter(input, options).AsBuffer();
        }
        ...
        ///
        ///     <h3><a href="http://docs.microsoft.com/en-gb/dotnet/csharp/programming-guide/concepts/linq/"><em>LINQ</em></a> Alternatives</h3>
        ///     <para>This extension method is essentially the same as chaining the <see cref="TokeniserExtensions.Shatter(ITokeniser, String, ShatteringOptions)" /> extension method and the <see cref="Enumerable.ToArray{TSource}(IEnumerable{TSource})" /> extension method. In fact, benchmark testing showed minimal overhead memory but no significant time consumption difference in respect of the <a href="http://docs.microsoft.com/en-gb/dotnet/csharp/programming-guide/concepts/linq/"><em>LINQ</em></a> solution. However, it is still provided as a convenience single-call self-explanatory method.</para>
        /// </remarks>
        ...
        ///
        ///     <h3><a href="http://docs.microsoft.com/en-gb/dotnet/csharp/programming-guide/concepts/linq/"><em>LINQ</em></a> Alternatives</h3>
        ///     <para>This extension method is essentially the same as chaining the <see cref="TokeniserExtensions.Shatter(ITokeniser, Stream, Encoding, ShatteringOptions)" /> extension method and the <see cref="Enumerable.ToArray{TSource}(IEnumerable{TSource})" /> extension method. In fact, benchmark testing showed minimal overhead memory but no significant time consumption difference in respect of the <a href="http://docs.microsoft.com/en-gb/dotnet/csharp/programming-guide/concepts/linq/"><em>LINQ</em></a> solution. However, it is still provided as a convenience single-call self-explanatory method.</para>
        /// </remarks>
        ...
        ///
        ///     <h3><a href="http://docs.microsoft.com/en-gb/dotnet/csharp/programming-guide/concepts/linq/"><em>LINQ</em></a> Alternatives</h3>
        ///     <para>This extension method is similar to chaining the <see cref="ITokeniser.ShatterAsync(TextReader, ShatteringOptions, Boolean, CancellationToken)" /> method and the <see cref="AsyncEnumerable.ToArrayAsync{TSource}(IAsyncEnumerable{TSource}, CancellationToken)" /> extension method. In fact, benchmark testing showed no significant time or memory consumption difference in respect of the <a href="http://docs.microsoft.com/en-gb/dotnet/csharp/programming-guide/concepts/linq/"><em>LINQ</em></a> solution. However, other than being a convenience single-call self-explanatory method, this method provides additional possibilities, such as intercepting the <see cref="OperationCanceledException" /> via the <c><paramref name="throwExceptionOnCancellation" /></c> and <c><paramref name="cancellationCallback" /></c> parameters.</para>
        /// </remarks>
        public static async Task<String?[]> ShatterToArrayAsync(this ITokeniser tokeniser, TextReader input, ShatteringOptions? options = null, Boolean continueTasksOnCapturedContext = false, Boolean throwExceptionOnCancellation = true, Action<OperationCanceledException>? cancellationCallback = null, CancellationToken cancellationToken = default)
        {
            if (tokeniser is null)
            {
                throw new ArgumentNullException(nameof(tokeniser), TokeniserNullErrorMessage);
        ...
        ///
        ///     <h3><a href="http://docs.microsoft.com/en-gb/dotnet/csharp/programming-guide/concepts/linq/"><em>LINQ</em></a> Alternatives</h3>
        ///     <para>This extension method is similar to chaining the <see cref="ShatterAsync(ITokeniser, String, ShatteringOptions, Boolean, CancellationToken)" /> extension method and the <see cref="AsyncEnumerable.ToArrayAsync{TSource}(IAsyncEnumerable{TSource}, CancellationToken)" /> extension method. In fact, benchmark testing showed no significant time or memory consumption difference in respect of the <a href="http://docs.microsoft.com/en-gb/dotnet/csharp/programming-guide/concepts/linq/"><em>LINQ</em></a> solution. However, other than being a convenience single-call self-explanatory method, this method provides additional possibilities, such as intercepting the <see cref="OperationCanceledException" /> via the <c><paramref name="throwExceptionOnCancellation" /></c> and <c><paramref name="cancellationCallback" /></c> parameters.</para>
        /// </remarks>
        ...
        ///
        ///     <h3><a href="http://docs.microsoft.com/en-gb/dotnet/csharp/programming-guide/concepts/linq/"><em>LINQ</em></a> Alternatives</h3>
        ///     <para>This extension method is similar to chaining the <see cref="ShatterAsync(ITokeniser, Stream, Encoding, ShatteringOptions, Boolean, CancellationToken)" /> extension method and the <see cref="AsyncEnumerable.ToArrayAsync{TSource}(IAsyncEnumerable{TSource}, CancellationToken)" /> extension method. In fact, benchmark testing showed no significant time or memory consumption difference in respect of the <a href="http://docs.microsoft.com/en-gb/dotnet/csharp/programming-guide/concepts/linq/"><em>LINQ</em></a> solution. However, other than being a convenience single-call self-explanatory method, this method provides additional possibilities, such as intercepting the <see cref="OperationCanceledException" /> via the <c><paramref name="throwExceptionOnCancellation" /></c> and <c><paramref name="cancellationCallback" /></c> parameters.</para>
        /// </remarks>
